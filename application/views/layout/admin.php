  ...
  <body style="background-color:#580000; background-image:url(<?php echo base_url(); ?>application/assets/images/pattern_3.png)">
    <div class="body_wrap">
      <div class="header_container">
        ...
        <?php $data2->load->view('admin/' . $class_router . '/' . $method_router); ?>
        <footer>
          <div class="container">
            ...
            <div class="copyright">
              <p>copyright 2013 - <strong>Marketing via Website</strong> <br> made by <a href="http://akbarbin-stagingapps.tk">akbarbin</a></p>
            </div>
          </div>
        </footer>
      </div>
